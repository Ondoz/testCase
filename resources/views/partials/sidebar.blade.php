        ...
        <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
            <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                ...
                <ul class="menu-nav">
                    ...
                    <li class="menu-item {{request()->is('materi') ? 'menu-item-active' : ''}}" aria-haspopup="true">
                        <a href="{{route('materi.index')}}" class="menu-link">
                            {{-- <i class="fa fa"></i> --}}
                            <i class="menu-icon  la la-address-book "></i>
                            {{-- <i class="fa fa-quote-right text-info mr-5"></i> --}}
                    ...
                    <li class="menu-item {{request()->is('paket') ? 'menu-item-active' : ''}}" aria-haspopup="true">
                        <a href="{{route('paket.index')}}" class="menu-link">
                            {{-- <i class="fa fa"></i> --}}
                            <i class="menu-icon  fa fa-comment-alt "></i>
                            {{-- <i class="fa fa-quote-right text-info mr-5"></i> --}}
                    ...
                    <li class="menu-item " aria-haspopup="true">
                        <a href="#" class="menu-link">
                            ...
                            {{-- <i class="fa fa-quote-right text-info mr-5"></i> --}}
                            <span class="menu-text">Vocer Soal</span>
                        </a>
                    </li>
