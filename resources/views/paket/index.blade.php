...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container">
        ...
        <div class="card card-custom">
            ...
            <div class="card-body">
                <!--begin: Datatable-->
                <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline" id="paket" style="margin-top: 13px !important">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Harga</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-form-label col-3 text-left">Name Paket * </label>
                        <div class="col-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="name" name="name" placeholder="Name Paket" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-3 text-left">Harga Paket * </label>
                        <div class="col-9">
                            <div class="input-group">
...
validator = FormValidation.formValidation(
    ...
    $(document).on('click', '.edit', function(){
     ...
     Paket_id = $(this).attr('id');
        $('h5').html("Edit Paket");
        $('.submit').text('Ok');
        $.ajax({
            url: "{{route('ajax.paketEdit')}}",
            type: 'POST',
            dataType: "JSON",
            data: {
                _token: '{{csrf_token()}}',
